...
replyTo = replyTo.lstrip("<")
replyTo = replyTo.rstrip(">")
...
for i in range(1, rc+1):
    ...
    #
    #
    # Adjust 'From:' header by using only the 'area' portion
    frh = mailHeaders["From"]
    ifrh = frh.find(" <")
    if (ifrh >= 0):
        frh,frh1,frh2 = frh.rpartition("<")
    mailHeaders["From"] = "\"{}\" <{}>".format(frh, replyTo)
